...
El objetivo del proyecto Cub 3d es realizar un videojuego utilizando Raycasting.

En el documentos subject.pdf podeis ver lo que se solicita.

El videojuego a realizar es [Wolfenstein 3D](https://fr.wikipedia.org/wiki/Wolfenstein_3D)
